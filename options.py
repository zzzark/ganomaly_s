...
class Options:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--w_i', type=float, default=0.5, help='i_latent classifier scores weight.')
        self.parser.add_argument('--w_o', type=float, default=0.5, help='o_latent classifier scores weight.')
